<%-- 
    Document   : actualizarcualquierusuario
    Created on : 25-feb-2019, 14:00:50
    Author     : USUARIO
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <tr><td colspan="2">Metodo:</td><td colspan="3"><input type="text" name="metodo" id="metodo" size="25" value="PUT2" readonly="readonly"/></td></tr>
        </table>
