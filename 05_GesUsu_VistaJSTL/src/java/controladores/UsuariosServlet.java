...
public class UsuariosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Seleccionar los campos login de los parametros o de las cookies
        ...
        if(ServicioUsuarios.getInstancia().validaLoginUsuario(email, password) == ServicioUsuarios.Resultado.Ok)
        {
            ...
            //Creamos y enviamos las cookies al navegador
        ...
        else//No Login
        {
            switch(request.getMethod()){
                case "POST"://Es el registro, viene de registrarse.jsp
                    ...
                    break;
                default: //Si intentamos loguearnos, o cualquier otra cosa y el login ha fallado
